    ...
    <section className="bg-white ">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
          ...
          <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
            {/**cCARrd */}
            <div className="items-center bg-gray-50 rounded-lg shadow-lg sm:flex border border-red-500 shadow-yellow-400">
              <a href="#">
                <img
            ...
            {/**cCARrd */}
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex border border-red-500">
              <a href="#">
                <img
                  className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"
